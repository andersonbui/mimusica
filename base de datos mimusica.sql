...
--
-- Servidor: localhost
-- Tiempo de generación: 17-06-2016 a las 06:39:18
...
INSERT INTO `acordes` (`id`, `ubicacion`) VALUES
('a', 'upload/acordes/a.jpg');
...
`id_cancion` int(11) NOT NULL,
  ...
  `letra` text NOT NULL,
  `total_reproduciones` char(255) NOT NULL DEFAULT '0',
...
(37, NULL, NULL, NULL, '', ''),
(38, 'jaime', 'Diaz', 'upload/imagenes/jaimito.jpg', '', '');
...
(1, 'andersonbuitron@unicauca.edu.co', '$2y$12$IMysC0ghikNJXYMbf7SFK.AKqLy5NecqJ0Q9L4.DNQOuE3roe4g6K', 'andersonb', '', 'anderson', NULL, 0, 'bk9ZiYnXEyQWPph3SB7rrmcQIWre9Auk', 1, NULL, 1466145409, '::1', 1463078216, 1463078216, 0),
...
(37, '', '', '', '', '', NULL, 1, '-g45G5E7Kh51o1M0fgeb3dwnco6cwT_w', NULL, NULL, NULL, '::1', 1466141741, 1466141741, 0),
(38, 'jaimitodiaz11@mailbox80.biz', '$2y$12$XByv6Jy02kXALT94oObb/uMVvhGSRrhov0yqdMNPhlCQVVN8cUIfa', 'jaimito', '', '', NULL, 1, 'n5_SttKjoL5tAQ4SLYN9N9r41Vd_Tl-t', 1466144989, NULL, NULL, '::1', 1466144980, 1466144980, 0);
...
--
ALTER TABLE `cancion`
 ADD PRIMARY KEY (`id_cancion`), ADD KEY `FK_es_autor_de` (`autor`), ADD KEY `FK_cancion_user` (`id_usuario`);
